...
#include "VertexBufferAttributes/VertexBufferAttributes.hpp"
#include "VertexBufferObject/VertexBufferObject.hpp"
...
public:
    ...
    const VertexBufferAttributesElement& GetAttributeElement(VertexBufferAttributesType vbType) const{
